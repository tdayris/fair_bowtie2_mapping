...
def get_bowtie2_alignment_input(wildcards: snakemake.io.Wildcards, samples: pandas.DataFrame = config) -> Dict[str, Union[Dict[str, str], str]]:
    """
...
def get_multiqc_report_input(wildcards: snakemake.io.Wildcards, samples: pandas.DataFrame = config) -> Dict[str, List[str]]:
    """
